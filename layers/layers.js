...
jsonSource_landmark_5.addFeatures(features_landmark_5);
var lyr_landmark_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_landmark_5, 
                style: style_landmark_5,
                popuplayertitle: 'landmark',
                interactive: true,
    title: 'landmark<br />\
    <img src="styles/legend/landmark_5_0.png" /> INFRASTRUKTUR<br />\
    <img src="styles/legend/landmark_5_1.png" /> LAHAN<br />' });

lyr_GoogleHybrid_0.setVisible(true);lyr_SosialEkonomi_1.setVisible(true);lyr_Infrastruktur_2.setVisible(true);lyr_Kekeringan_3.setVisible(true);lyr_KetersediaanLahan_4.setVisible(true);lyr_landmark_5.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_SosialEkonomi_1,lyr_Infrastruktur_2,lyr_Kekeringan_3,lyr_KetersediaanLahan_4,lyr_landmark_5];
...
lyr_landmark_5.set('fieldAliases', {'fid': 'fid', 'nama': 'nama', 'alamat': 'alamat', 'latitude_left': 'latitude_left', 'longitude_left': 'longitude_left', 'group': 'group', 'search_key': 'search_key', 'kategori': 'kategori', 'index_right': 'index_right', 'GID_4': 'GID_4', 'GID_0': 'GID_0', 'COUNTRY': 'COUNTRY', 'GID_1': 'GID_1', 'NAME_1': 'NAME_1', 'GID_2': 'GID_2', 'NAME_2': 'NAME_2', 'GID_3': 'GID_3', 'NAME_3': 'NAME_3', 'NAME_4': 'NAME_4', 'VARNAME_4': 'VARNAME_4', 'TYPE_4': 'TYPE_4', 'ENGTYPE_4': 'ENGTYPE_4', 'CC_4': 'CC_4', 'longitude_right': 'longitude_right', 'latitude_right': 'latitude_right', });
...
lyr_landmark_5.set('fieldLabels', {'fid': 'hidden field', 'nama': 'hidden field', 'alamat': 'hidden field', 'latitude_left': 'hidden field', 'longitude_left': 'hidden field', 'group': 'hidden field', 'search_key': 'hidden field', 'kategori': 'inline label - visible with data', 'index_right': 'hidden field', 'GID_4': 'hidden field', 'GID_0': 'hidden field', 'COUNTRY': 'hidden field', 'GID_1': 'hidden field', 'NAME_1': 'hidden field', 'GID_2': 'hidden field', 'NAME_2': 'hidden field', 'GID_3': 'hidden field', 'NAME_3': 'hidden field', 'NAME_4': 'hidden field', 'VARNAME_4': 'hidden field', 'TYPE_4': 'hidden field', 'ENGTYPE_4': 'hidden field', 'CC_4': 'hidden field', 'longitude_right': 'hidden field', 'latitude_right': 'hidden field', });
lyr_landmark_5.on('precompose', function(evt) {
